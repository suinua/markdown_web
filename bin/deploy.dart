...
void main() async {
  ...
  //Push
  var pushResult = await Process.run('git', ['push', '-f', '--set-upstream', 'origin']);
  print('git push -f --set-upstream origin > stdout: ${pushResult.stdout}');
  print('git push -f --set-upstream origin > stderr: ${pushResult.stderr}');
}
